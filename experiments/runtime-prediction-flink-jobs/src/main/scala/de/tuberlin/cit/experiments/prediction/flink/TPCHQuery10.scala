...
object TPCHQuery10 {
  ...
  def main(args: Array[String]) {
    ...
    val orders1990 = orders
      .filter(_._3.substring(0, 4).toInt > 1990)
      .map(o => (o._1, o._2))
    ...
    val revenueByCustomer = orders1990
      .joinWithHuge(lineitemsReturn).where(0).equalTo(0) {
        (o, l) => (o._2, l._2)
      }
      .groupBy(0)
      .sum(1)
    ...
    val result = customers
      .joinWithTiny(nations).where(3).equalTo(0) {
        (c, n) => (c._1, c._2, c._3, n._2, c._5)
      }
      .join(revenueByCustomer).where(0).equalTo(0) {
        (c, r) => (c._1, c._2, c._3, c._4, c._5, r._2)
      }
  ...
  private def parseParameters(args: Array[String]): Boolean = {
    if (args.length == 5) {
      ...
      Console.err.println("This program expects data from the TPC-H benchmark as input data.\n" +
  ...
  private def getLineitemDataSet(env: ExecutionEnvironment): DataSet[Tuple4[Int, Double, Double, String]] = {
